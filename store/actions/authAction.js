...
export const authenticate = (userId, token, expiryTime) => {
  return (dispatch) => {
    dispatch(setLogoutTimer(expiryTime)); // we want to be able to dispatch the
    //logout action later (when the timer expired) to update the Redux state appropriately
